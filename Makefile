.PHONY: build-pool-data build-knockout-predictions build-consensus-predictions build-round-of-32-consensus build-round-of-16-consensus update-official-results update-official-knockout-results apply-manual-futures create-official-checkpoint rebuild-official-checkpoints build-site test
...
build-site:
	...
	cp -R apps public/
	cp -R static public/
	cp data/generated/consensus_predictions.json data/generated/knockout_predictions.js data/generated/official_results.js data/generated/pool_data.js data/generated/round_of_32_consensus.json data/generated/round_of_16_consensus.json public/data/generated/

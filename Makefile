.PHONY: build-pool-data build-knockout-predictions build-consensus-predictions build-round-of-32-consensus update-official-results update-official-knockout-results apply-manual-futures create-official-checkpoint rebuild-official-checkpoints build-site test
